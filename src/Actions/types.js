...
export const ADD_SET_MENU_SANDWITCHES_TO_BASKET = 'ADD_SET_MENU_SANDWITCHES_TO_BASKET'
export const ADD_SET_MENU_DRINKS_TO_BASKET = 'ADD_SET_MENU_DRINKS_TO_BASKET'
